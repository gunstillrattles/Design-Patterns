...
public class CompressionDecorator extends kz.narxoz.patterns.decorator.DataSourceDecorator {
    ...
    public void writeData(File inputFileName) throws IOException, CryptoException {
        ...
        File outputFile = new File(
                "src/main/java/kz/narxoz/patterns/decorator/tmp/tmp_comp_file");
...
//
//        File outputFile = new File(
//                "src/main/java/kz/narxoz/patterns/decorator/tmp/tmp_decomp_file");
//
//        FileOutputStream fos=new FileOutputStream(outputFile);
